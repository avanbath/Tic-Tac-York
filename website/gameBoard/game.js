...
function initBoard() {
    ...
    for (var i = 1; i <= 3; i++) {
        for (var j = 0; j <= 2; j += 1) {
            ...
            $(newInput).css("background-color", "white");
            $(newInput).css("height", "150px");
            $(newInput).css("width", "150px");
            $(newInput).css("margin-bottom", "-5px");
            
            if (j == 0) {
                $(newInput).css("border-left", "2px solid rgb(200, 0, 0)");
            }
            if (j == 2){
                $(newInput).css("border-right", "2px solid rgb(200, 0, 0)");
            }

            if (i == 3){
                $(newInput).css("margin-bottom", "15px");
                $(newInput).css("border-bottom", "2px solid rgb(200, 0, 0)");
            }
            if (i == 1){
                $(newInput).css("margin-top", "15px");
                $(newInput).css("border-top", "2px solid rgb(200, 0, 0)");
            }
